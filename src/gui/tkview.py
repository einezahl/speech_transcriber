...
class TkView:
    def setup(self, controller):
        ...
        self.start_stop_recording_button = tk.Button(
            self.frame_buttons,
            text="Start Recording",
            command=controller.start_recording
        )
        self.start_stop_recording_button.pack()
        self.delete_recording_button = tk.Button(
            self.frame_buttons,
            text="Delete Recording",
            command=controller.delete_recording
        )
        self.delete_recording_button.pack()
        self.play_recording_button = tk.Button(
            self.frame_buttons,
            text="Play Recording",
            command=controller.play_recording
        )
        self.play_recording_button.pack()
        self.transcribed_button = tk.Button(
            self.frame_buttons,
            text="Transcribe Recording",
            command=controller.transcribe_recording
        )
